...
.socials a.fb:hover { background: #1877f2; color: #fff; }
.socials a.ig:hover { background: linear-gradient(45deg, #f09433, #e6683c, #dc2743, #cc2366, #bc1888); color: #fff; }
.socials a.mail:hover { background: #ea4335; color: #fff; }
...
.footer-col ul a i { width: 18px; text-align: center; flex-shrink: 0; }
...
<section class="section" id="contact">
  <div class="container">
    <div class="cta-strip">
      ...
      <a href="mailto:mstrajiasultanatumpa@gmail.com" class="btn">
        <i class="fas fa-envelope"></i>
        <span data-lang="bn">Rajia কে ইমেইল করুন</span>
        <span data-lang="en">Email Rajia</span>
      </a>

      <!-- QUICK CONTACT LINKS -->
      <div class="cta-contact-list">
        <a href="https://www.facebook.com/share/183F8J3kzu/" target="_blank" rel="noopener">
          <i class="fab fa-facebook-f"></i>
          <span data-lang="bn">ফেসবুক পেজ</span>
          <span data-lang="en">Facebook Page</span>
        </a>
        <a href="https://www.instagram.com/sani.al.isnine?stkn=MTF5b2w2anMxY3NlZg==" target="_blank" rel="noopener">
          <i class="fab fa-instagram"></i>
          <span data-lang="bn">ইনস্টাগ্রাম</span>
  ...
  <div class="container">
    <div class="footer-grid">
      <div class="footer-brand">
        ...
        <div class="socials">
          <a href="https://www.facebook.com/share/183F8J3kzu/" target="_blank" rel="noopener" class="fb" aria-label="Facebook">
            <i class="fab fa-facebook-f"></i>
          </a>
          <a href="https://www.instagram.com/sani.al.isnine?stkn=MTF5b2w2anMxY3NlZg==" target="_blank" rel="noopener" class="ig" aria-label="Instagram">
            <i class="fab fa-instagram"></i>
          </a>
          <a href="mailto:mstrajiasultanatumpa@gmail.com" class="mail" aria-label="Email">
            <i class="fas fa-envelope"></i>
          </a>
        </div>
      </div>
      ...
      <div class="footer-col">
        ...
        <ul>
          <li>
            <a href="mailto:mstrajiasultanatumpa@gmail.com">
              <i class="fas fa-envelope"></i> mstrajiasultanatumpa@gmail.com
            </a>
          </li>
          <li>
            <a href="https://www.facebook.com/share/183F8J3kzu/" target="_blank" rel="noopener">
